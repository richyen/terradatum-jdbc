...
public class SubParentObj implements DbStruct {
   ...
   */
  public SubParentObj(BigDecimal subParentId, String parentType) {
  ...
  public void setAttributes(Object[] attributes) throws SQLException, InvocationTargetException,
    ...
    subParentId = ConverterUtil.convert(attributes[0], BigDecimal.class);
    parentType = ConverterUtil.convert(attributes[1], String.class);
  }

  public BigDecimal getSubParentId() {
    return subParentId;
  }

  public void setSubParentId(BigDecimal subParentId) {
    this.subParentId = subParentId;
  }
