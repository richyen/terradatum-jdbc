 ...
 * @date 2016-03-06T18:22:55.051
 */
public class SysParmsObj implements DbStruct {
  public static final String SQL_TYPE_NAME = "metrics.sys_parms_obj";
  ...
  public SysParmsObj() {
     ...
     */
  @SuppressWarnings("unused")
  public SysParmsObj(String parmKey, String parmValue) {
  ...
  public Object[] getAttributes() throws SQLException {
    return new Object[]{parmKey, parmValue};
  }
  ...
  public void setAttributes(Object[] attributes) throws SQLException, InvocationTargetException,
    ...
    parmKey = ConverterUtil.convert(attributes[0], String.class);
    parmValue = ConverterUtil.convert(attributes[1], String.class);
  }
  ...
  public boolean equals(Object o) {
    ...
    SysParmsObj that = (SysParmsObj) o;
    return
      Objects.equals(getParmKey(), that.getParmKey()) &&
      Objects.equals(getParmValue(), that.getParmValue());
  }
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        .add("parmKey", getParmKey())
        .add("parmValue", getParmValue()).toString();
  }
}