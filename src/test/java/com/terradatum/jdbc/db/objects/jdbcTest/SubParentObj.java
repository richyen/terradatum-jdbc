 ...
 * @date 2016-03-28T19:45:12.564
 */
public class SubParentObj implements DbStruct {
  public static final String SQL_TYPE_NAME = "jdbc_test.sub_parent_obj";

  private java.math.BigDecimal subParentId;
   ...
   */
  public SubParentObj(java.math.BigDecimal subParentId, String parentType) {
  ...
  public Object[] getAttributes() throws SQLException {
    return new Object[]{subParentId, parentType};
  }
  ...
  public void setAttributes(Object[] attributes) throws SQLException, InvocationTargetException,
    ...
    subParentId = ConverterUtil.convert(attributes[0], java.math.BigDecimal.class);
    parentType = ConverterUtil.convert(attributes[1], String.class);
  }

  public java.math.BigDecimal getSubParentId() {
    return subParentId;
  }

  public void setSubParentId(java.math.BigDecimal subParentId) {
    this.subParentId = subParentId;
  }
  ...
  public boolean equals(Object o) {
    ...
    SubParentObj that = (SubParentObj) o;
    return
      Objects.equals(getSubParentId(), that.getSubParentId()) &&
      Objects.equals(getParentType(), that.getParentType());
  }
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        .add("subParentId", getSubParentId())
        .add("parentType", getParentType()).toString();
  }
}