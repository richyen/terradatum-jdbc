 ...
 * @date 1/25/16
 */
public abstract class JdbcCallableStatementAdapter extends JdbcPreparedStatementAdapter implements DbCallableStatementAdapter {

  /**
   * constructor for use by subclasses
   **/
  protected JdbcCallableStatementAdapter() {
  }

  @Override
  protected abstract CallableStatement delegate();

  @Override
  public abstract JdbcConnectionAdapter getConnectionAdapter();

  @Override
  public void setData(int index, DbData data) throws SQLException {
    if (data instanceof DbStruct) {
      this.setStruct(index, (DbStruct) data);
    } else if (data instanceof JdbcArrayList) {
      this.setArray(index, (JdbcArrayList<?>) data);
    }
  }

  /**
   * Registers the parameter in ordinal position <code>parameterIndex</code> to be of JDBC type <code>sqlType</code>. All OUT
   ...
   * <p>
   * This version of <code>registerOutParameter</code> should be used when the parameter is of JDBC type <code>NUMERIC</code> or
   * <code>DECIMAL</code>.
   *
  ...
  /**
   * Retrieves whether the last OUT parameter read had the value of SQL <code>NULL</code>. Note that this method should be called
   * only after calling a getter method; otherwise, there is no value to use in determining whether it is <code>null</code> or
   * not.
   *
   * @return <code>true</code> if the last parameter read was SQL <code>NULL</code>; <code>false</code> otherwise
   * @throws SQLException
  ...
  /**
   * Retrieves the value of the designated JDBC <code>CHAR</code>, <code>VARCHAR</code>, or <code>LONGVARCHAR</code> parameter as
   * a <code>String</code> in the Java programming language.
   * <p>
   * For the fixed-length type JDBC <code>CHAR</code>, the <code>String</code> object returned has exactly the same value the SQL
   * <code>CHAR</code> value had in the database, including any padding added by the database.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value. If the value is SQL <code>NULL</code>, the result is <code>null</code>.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
   * @see #setString
  ...
  /**
   * Retrieves the value of the designated JDBC <code>BIT</code> or <code>BOOLEAN</code> parameter as a <code>boolean</code> in
   * the Java programming language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value. If the value is SQL <code>NULL</code>, the result is <code>false</code>.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
   * @see #setBoolean
  ...
  /**
   * Retrieves the value of the designated JDBC <code>TINYINT</code> parameter as a <code>byte</code> in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value. If the value is SQL <code>NULL</code>, the result is <code>0</code>.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
   * @see #setByte
  ...
  /**
   * Retrieves the value of the designated JDBC <code>SMALLINT</code> parameter as a <code>short</code> in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
  ...
  /**
   * Retrieves the value of the designated JDBC <code>INTEGER</code> parameter as an <code>int</code> in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
  ...
  /**
   * Retrieves the value of the designated JDBC <code>BIGINT</code> parameter as a <code>long</code> in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
  ...
  /**
   * Retrieves the value of the designated JDBC <code>FLOAT</code> parameter as a <code>float</code> in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
  ...
  /**
   * Retrieves the value of the designated JDBC <code>DOUBLE</code> parameter as a <code>double</code> in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
  ...
  /**
   * Retrieves the value of the designated JDBC <code>NUMERIC</code> parameter as a <code>java.math.BigDecimal</code> object with
   * <i>scale</i> digits to the right of the decimal point.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @param scale
  ...
  /**
   * Retrieves the value of the designated JDBC <code>BINARY</code> or <code>VARBINARY</code> parameter as an array of
   * <code>byte</code> values in the Java programming language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value. If the value is SQL <code>NULL</code>, the result is <code>null</code>.
  ...
  /**
   * Retrieves the value of the designated parameter as an <code>Object</code> in the Java programming language. If the value is
   * an SQL <code>NULL</code>, the driver returns a Java <code>null</code>.
   * <p>
   * This method returns a Java object whose type corresponds to the JDBC type that was registered for this parameter using the
   * method <code>registerOutParameter</code>. By registering the target JDBC type as <code>java.sql.Types.OTHER</code>, this
   ...
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value in full precision. If the value is SQL <code>NULL</code>, the result is <code>null</code>.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
   * @see #setBigDecimal
  ...
  /**
   * Returns an object representing the value of OUT parameter <code>parameterIndex</code> and uses <code>map</code> for the
  ...
  /**
   * Retrieves the value of the designated JDBC <code>REF(&lt;structured-type&gt;)</code> parameter as a {@link Ref} object in the
   * Java programming language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value as a <code>Ref</code> object in the Java programming language. If the value was SQL
  ...
  /**
   * Retrieves the value of the designated JDBC <code>BLOB</code> parameter as a {@link Blob} object in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value as a <code>Blob</code> object in the Java programming language. If the value was SQL
   *         <code>NULL</code>, the value <code>null</code> is returned.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
  ...
  /**
   * Retrieves the value of the designated JDBC <code>CLOB</code> parameter as a <code>java.sql.Clob</code> object in the Java
   * programming language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value as a <code>Clob</code> object in the Java programming language. If the value was SQL
   *         <code>NULL</code>, the value <code>null</code> is returned.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
  ...
  /**
   * Retrieves the value of the designated JDBC <code>ARRAY</code> parameter as an {@link Array} object in the Java programming
   * language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value as an <code>Array</code> object in the Java programming language. If the value was SQL
   *         <code>NULL</code>, the value <code>null</code> is returned.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
  ...
  /**
   * Retrieves the value of the designated JDBC <code>DATE</code> parameter as a <code>java.sql.Date</code> object, using the
   * given <code>Calendar</code> object to construct the date. With a <code>Calendar</code> object, the driver can calculate the
   * date taking into account a custom timezone and locale. If no <code>Calendar</code> object is specified, the driver uses the
  ...
  /**
   * Retrieves the value of the designated JDBC <code>TIME</code> parameter as a <code>java.sql.Time</code> object, using the
   * given <code>Calendar</code> object to construct the time. With a <code>Calendar</code> object, the driver can calculate the
   * time taking into account a custom timezone and locale. If no <code>Calendar</code> object is specified, the driver uses the
   * default timezone and locale.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
  ...
  /**
   * Retrieves the value of the designated JDBC <code>TIMESTAMP</code> parameter as a <code>java.sql.Timestamp</code> object,
   * using the given <code>Calendar</code> object to construct the <code>Timestamp</code> object. With a <code>Calendar</code>
   * object, the driver can calculate the timestamp taking into account a custom timezone and locale. If no <code>Calendar</code>
  ...
  /**
   * Registers the parameter named <code>parameterName</code> to be of JDBC type <code>sqlType</code>. All OUT parameters must be
   ...
   * user-named or REF output parameter. Examples of user-named types include: STRUCT, DISTINCT, JAVA_OBJECT, and named array
   * types.
   * <p>
   * All OUT parameters must be registered before a stored procedure is executed.
   * <p>
   * For a user-named parameter the fully-qualified SQL type name of the parameter should also be given, while a REF parameter
   * requires that the fully-qualified type name of the referenced type be given. A JDBC driver that does not need the type code
   * and type name information may ignore it. To be portable, however, applications should always provide these values for
   * user-named and REF parameters.
   * <p>
   * Although it is intended for user-named and REF parameters, this method may be used to register a parameter of any JDBC type.
   * If the parameter does not have a user-named or REF type, the typeName parameter is ignored.
   * <p>
   * <P>
   * <B>Note:</B> When reading the value of an out parameter, you must use the <code>getXXX</code> method whose Java type XXX
   ...
   * @return a <code>java.net.URL</code> object that represents the JDBC <code>DATALINK</code> value used as the designated
   *         parameter
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs, this method is called on a closed
  ...
  /**
   * Sets the designated parameter to the given <code>java.net.URL</code> object. The driver converts this to an SQL
   ...
   *          the parameter value
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs; this method is called
   ...
   * Sets the value of the designated parameter with the given object.
   * <p>
   * This method is similar to {@link #setObject(String parameterName, Object x, int targetSqlType, int scaleOrLength)}, except
   ...
   * <code>setNull</code> or the <code>setObject(String parameterName, Object x, int sqlType)</code> method should be used instead
   * of <code>setObject(String parameterName, Object x)</code>.
   * <p>
   *
   * @param parameterName
   *          the name of the parameter
   ...
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs, this method is called
   *           on a closed <code>CallableStatement</code> or if the given <code>Object</code> parameter is ambiguous
   * @throws SQLFeatureNotSupportedException
   *           if the JDBC driver does not support this method
   * @see #getObject
   * @since 1.4
   ...
   *          the name of the parameter
   * @param reader
   *          the <code>java.io.Reader</code> object that contains the UNICODE data used as the designated parameter
   * @param length
   ...
   * the database. With a a <code>Calendar</code> object, the driver can calculate the date taking into account a custom timezone.
   ...
   * the database. With a a <code>Calendar</code> object, the driver can calculate the time taking into account a custom timezone.
   * If no <code>Calendar</code> object is specified, the driver uses the default timezone, which is that of the virtual machine
   * running the application.
   *
   * @param parameterName
   ...
   * then sends to the database. With a a <code>Calendar</code> object, the driver can calculate the timestamp taking into account
   * a custom timezone. If no <code>Calendar</code> object is specified, the driver uses the default timezone, which is that of
   ...
   * a REF parameter, the name is the type name of the referenced type.
   * <p>
   ...
   * @param typeName
   *          the fully-qualified name of an SQL user-defined type; ignored if the parameter is not a user-defined type or SQL
   *          <code>REF</code> value
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs or this method is
   *           called on a closed <code>CallableStatement</code>
  ...
  /**
   * Retrieves the value of a JDBC <code>CHAR</code>, <code>VARCHAR</code>, or <code>LONGVARCHAR</code> parameter as a
  ...
  /**
   * Retrieves the value of a JDBC <code>BIT</code> or <code>BOOLEAN</code> parameter as a <code>boolean</code> in the Java
   * programming language.
   *
   * @param parameterName
   *          the name of the parameter
  ...
  /**
   * Retrieves the value of a JDBC <code>BINARY</code> or <code>VARBINARY</code> parameter as an array of <code>byte</code> values
  ...
  /**
   * Retrieves the value of a parameter as an <code>Object</code> in the Java programming language. If the value is an SQL
  ...
  /**
   * Retrieves the value of a JDBC <code>NUMERIC</code> parameter as a <code>java.math.BigDecimal</code> object with as many
  ...
  /**
   * Returns an object representing the value of OUT parameter <code>parameterName</code> and uses <code>map</code> for the custom
  ...
  /**
   * Retrieves the value of a JDBC <code>REF(&lt;structured-type&gt;)</code> parameter as a {@link Ref} object in the Java
   * programming language.
   *
   * @param parameterName
   *          the name of the parameter
  ...
  /**
   * Retrieves the value of a JDBC <code>BLOB</code> parameter as a {@link Blob} object in the Java programming language.
   *
   * @param parameterName
   *          the name of the parameter
   * @return the parameter value as a <code>Blob</code> object in the Java programming language. If the value was SQL
  ...
  /**
   * Retrieves the value of a JDBC <code>CLOB</code> parameter as a <code>java.sql.Clob</code> object in the Java programming
   * language.
   *
   * @param parameterName
   *          the name of the parameter
  ...
  /**
   * Retrieves the value of a JDBC <code>ARRAY</code> parameter as an {@link Array} object in the Java programming language.
   *
   * @param parameterName
   *          the name of the parameter
   * @return the parameter value as an <code>Array</code> object in Java programming language. If the value was SQL
   *         <code>NULL</code>, the value <code>null</code> is returned.
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs or this method is
   *           called on a closed <code>CallableStatement</code>
  ...
  /**
   * Retrieves the value of a JDBC <code>DATE</code> parameter as a <code>java.sql.Date</code> object, using the given
   * <code>Calendar</code> object to construct the date. With a <code>Calendar</code> object, the driver can calculate the date
   * taking into account a custom timezone and locale. If no <code>Calendar</code> object is specified, the driver uses the
   * default timezone and locale.
   *
   * @param parameterName
   *          the name of the parameter
  ...
  /**
   * Retrieves the value of a JDBC <code>TIME</code> parameter as a <code>java.sql.Time</code> object, using the given
   * <code>Calendar</code> object to construct the time. With a <code>Calendar</code> object, the driver can calculate the time
   * taking into account a custom timezone and locale. If no <code>Calendar</code> object is specified, the driver uses the
   * default timezone and locale.
   *
   * @param parameterName
  ...
  /**
   * Retrieves the value of a JDBC <code>TIMESTAMP</code> parameter as a <code>java.sql.Timestamp</code> object, using the given
   * <code>Calendar</code> object to construct the <code>Timestamp</code> object. With a <code>Calendar</code> object, the driver
   * can calculate the timestamp taking into account a custom timezone and locale. If no <code>Calendar</code> object is
   ...
   * @param parameterName
   *          the name of the parameter
   * @return the parameter value as a <code>java.net.URL</code> object in the Java programming language. If the value was SQL
   *         <code>NULL</code>, the value <code>null</code> is returned.
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs, this method is called
   *           on a closed <code>CallableStatement</code>, or if there is a problem with the URL
   * @throws SQLFeatureNotSupportedException
   *           if the JDBC driver does not support this method
   * @see #setURL
   * @since 1.4
  ...
  /**
   * Retrieves the value of the designated JDBC <code>ROWID</code> parameter as a <code>java.sql.RowId</code> object.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2,...
   * @return a <code>RowId</code> object that represents the JDBC <code>ROWID</code> value is used as the designated parameter. If
   *         the parameter contains a SQL <code>NULL</code>, then a <code>null</code> value is returned.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
   * @throws SQLFeatureNotSupportedException
   ...
   * or <code>NVARCHAR</code> or <code>LONGNVARCHAR</code>
   *
   * @param parameterName
   ...
   *          the parameter value
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if the driver does not support national character sets;
   *           if the driver can detect that a data conversion error could occur; if a database access error occurs or this method
  ...
  /**
   * Sets the designated parameter to a <code>java.sql.NClob</code> object. The object implements the <code>java.sql.NClob</code>
  ...
  /**
   * Sets the designated parameter to a <code>Reader</code> object. The <code>reader</code> must contain the number of characters
   * specified by length otherwise a <code>SQLException</code> will be generated when the <code>CallableStatement</code> is
   * executed. This method differs from the <code>setCharacterStream (int, Reader, int)</code> method because it informs the
   * driver that the parameter value should be sent to the server as a <code>CLOB</code>. When the <code>setCharacterStream</code>
   * method is used, the driver may have to do extra work to determine whether the parameter data should be send to the server as
   * a <code>LONGVARCHAR</code> or a <code>CLOB</code>
   *
   * @param parameterName
   *          the name of the parameter to be set
   * @param reader
   ...
   *          the number of characters in the parameter data.
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if the length specified is less than zero; a database
  ...
  /**
   * Sets the designated parameter to a <code>InputStream</code> object. The <code>inputstream</code> must contain the number of
   * characters specified by length, otherwise a <code>SQLException</code> will be generated when the
   * <code>CallableStatement</code> is executed. This method differs from the <code>setBinaryStream (int, InputStream, int)</code>
   * method because it informs the driver that the parameter value should be sent to the server as a <code>BLOB</code>. When the
   ...
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if the length specified is less than zero; if the number
   *           of bytes in the inputstream does not match the specified length; if a database access error occurs or this method
   *           is called on a closed <code>CallableStatement</code>
   * @throws SQLFeatureNotSupportedException
   *           if the JDBC driver does not support this method
   * @since 1.6
   ...
   * specified by length otherwise a <code>SQLException</code> will be generated when the <code>CallableStatement</code> is
   * executed. This method differs from the <code>setCharacterStream (int, Reader, int)</code> method because it informs the
   * driver that the parameter value should be sent to the server as a <code>NCLOB</code>. When the
   * <code>setCharacterStream</code> method is used, the driver may have to do extra work to determine whether the parameter data
   * should be send to the server as a <code>LONGNVARCHAR</code> or a <code>NCLOB</code>
   *
   * @param parameterName
   *          the name of the parameter to be set
   * @param reader
   ...
   *          the number of characters in the parameter data.
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if the length specified is less than zero; if the driver
   *           does not support national character sets; if the driver can detect that a data conversion error could occur; if a
  ...
  /**
   * Retrieves the value of the designated JDBC <code>NCLOB</code> parameter as a <code>java.sql.NClob</code> object in the Java
   * programming language.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @return the parameter value as a <code>NClob</code> object in the Java programming language. If the value was SQL
   *         <code>NULL</code>, the value <code>null</code> is returned.
   * @throws SQLException
   *           if the parameterIndex is not valid; if the driver does not support national character sets; if the driver can
  ...
  /**
   * Retrieves the value of a JDBC <code>NCLOB</code> parameter as a <code>java.sql.NClob</code> object in the Java programming
   * language.
   *
   * @param parameterName
   *          the name of the parameter
   ...
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs; this method is called
   *           on a closed <code>CallableStatement</code> or the <code>java.xml.transform.Result</code>, <code>Writer</code> or
   *           <code>OutputStream</code> has not been closed for the <code>SQLXML</code> object
   * @throws SQLFeatureNotSupportedException
   *           if the JDBC driver does not support this method
   * @since 1.6
   */
  ...
  /**
   * Retrieves the value of the designated <code>SQL XML</code> parameter as a <code>java.sql.SQLXML</code> object in the Java
   * programming language.
   *
   * @param parameterIndex
  ...
  /**
   * Retrieves the value of the designated <code>NCHAR</code>, <code>NVARCHAR</code> or <code>LONGNVARCHAR</code> parameter as a
   * <code>String</code> in the Java programming language.
   * <p>
   * For the fixed-length type JDBC <code>NCHAR</code>, the <code>String</code> object returned has exactly the same value the SQL
   * <code>NCHAR</code> value had in the database, including any padding added by the database.
   *
   * @param parameterIndex
   *          index of the first parameter is 1, the second is 2, ...
   * @return a <code>String</code> object that maps an <code>NCHAR</code>, <code>NVARCHAR</code> or <code>LONGNVARCHAR</code>
   *         value
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
   *           <code>CallableStatement</code>
  ...
  /**
   * Retrieves the value of the designated parameter as a <code>java.io.Reader</code> object in the Java programming language. It
   * is intended for use when accessing <code>NCHAR</code>,<code>NVARCHAR</code> and <code>LONGNVARCHAR</code> parameters.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, ...
   * @return a <code>java.io.Reader</code> object that contains the parameter value; if the value is SQL <code>NULL</code>, the
   ...
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if the driver does not support national character sets;
   *           if the driver can detect that a data conversion error could occur; if a database access error occurs; or this
   ...
   * work to determine whether the parameter data should be send to the server as a <code>LONGVARCHAR</code> or a
   * <code>CLOB</code>
   * <p>
   * <P>
   * <B>Note:</B> Consult your JDBC driver documentation to determine if it might be more efficient to use a version of
   ...
   * work to determine whether the parameter data should be send to the server as a <code>LONGVARBINARY</code> or a
   * <code>BLOB</code>
   * <p>
   * <P>
   * <B>Note:</B> Consult your JDBC driver documentation to determine if it might be more efficient to use a version of
   ...
   * work to determine whether the parameter data should be send to the server as a <code>LONGNVARCHAR</code> or a
   * <code>NCLOB</code>
   * <P>
   * <B>Note:</B> Consult your JDBC driver documentation to determine if it might be more efficient to use a version of
  ...
  /**
   * <p>
   * Returns an object representing the value of OUT parameter {@code parameterIndex} and will convert from the SQL type of the
   * parameter to the requested Java data type, if the conversion is supported. If the conversion is not supported or null is
   * specified for the type, a <code>SQLException</code> is thrown.
   * <p>
   * At a minimum, an implementation must support the conversions defined in Appendix B, Table B-3 and conversion of appropriate
   * user defined SQL types to a Java type which implements {@code SQLData}, or {@code Struct}. Additional conversions may be
   * supported and are vendor defined.
   *
   * @param parameterIndex
   *          the first parameter is 1, the second is 2, and so on
   * @param type
   *          Class representing the Java data type to convert the designated parameter to.
   * @return an instance of {@code type} holding the OUT parameter value
   * @throws SQLException
   *           if conversion is not supported, type is null or another error occurs. The getCause() method of the exception may
   *           provide a more detailed exception, for example, if a conversion error occurs
   * @throws SQLFeatureNotSupportedException
   *           if the JDBC driver does not support this method
   * @since 1.7
   */
  ...
  /**
   * <p>
   * Returns an object representing the value of OUT parameter {@code parameterName} and will convert from the SQL type of the
   * parameter to the requested Java data type, if the conversion is supported. If the conversion is not supported or null is
   * specified for the type, a <code>SQLException</code> is thrown.
   * <p>
   * At a minimum, an implementation must support the conversions defined in Appendix B, Table B-3 and conversion of appropriate
   ...
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs or this method is
   *           called on a closed {@code CallableStatement} or if the Java Object specified by x is an InputStream or Reader
   ...
   * @throws SQLException
   *           if parameterName does not correspond to a named parameter; if a database access error occurs or this method is
   *           called on a closed {@code CallableStatement}
   * @throws SQLFeatureNotSupportedException
   *           if the JDBC driver does not support the specified targetSqlType
   * @see JDBCType
   * @see SQLType
  ...
  /**
   * Registers the OUT parameter in ordinal position {@code parameterIndex} to the JDBC type {@code sqlType}. All OUT parameters
   * must be registered before a stored procedure is executed.
   * <p>
   * The JDBC type specified by {@code sqlType} for an OUT parameter determines the Java type that must be used in the {@code get}
   * method to read the value of that parameter.
   * <p>
   * If the JDBC type expected to be returned to this output parameter is specific to this particular database, {@code sqlType}
   * may be {@code JDBCType.OTHER} or a {@code SQLType} that is supported by the JDBC driver. The method {@link #getObject}
   * retrieves the value.
   * <p>
   * The default implementation will throw {@code SQLFeatureNotSupportedException}
   *
   ...
   *          the first parameter is 1, the second is 2, and so on
   * @param sqlType
   *          the JDBC type code defined by {@code SQLType} to use to register the OUT Parameter. If the parameter is of JDBC type
   *          {@code JDBCType.NUMERIC} or {@code JDBCType.DECIMAL}, the version of {@code registerOutParameter} that accepts a
  ...
  /**
   * Registers the parameter in ordinal position {@code parameterIndex} to be of JDBC type {@code sqlType}. All OUT parameters
   * must be registered before a stored procedure is executed.
   * <p>
   * The JDBC type specified by {@code sqlType} for an OUT parameter determines the Java type that must be used in the {@code get}
   * method to read the value of that parameter.
   * <p>
   * This version of {@code  registerOutParameter} should be used when the parameter is of JDBC type {@code JDBCType.NUMERIC} or
   ...
   *          the first parameter is 1, the second is 2, and so on
   * @param sqlType
   *          the JDBC type code defined by {@code SQLType} to use to register the OUT Parameter.
   * @param scale
   *          the desired number of digits to the right of the decimal point. It must be greater than or equal to zero.
   * @throws SQLException
   *           if the parameterIndex is not valid; if a database access error occurs or this method is called on a closed
  ...
  /**
   * Registers the designated output parameter. This version of the method {@code  registerOutParameter} should be used for a
   * user-defined or {@code REF} output parameter. Examples of user-defined types include: {@code STRUCT}, {@code DISTINCT},
   * {@code JAVA_OBJECT}, and named array types.
   * <p>
   * All OUT parameters must be registered before a stored procedure is executed.
   * <p>
   * For a user-defined parameter, the fully-qualified SQL type name of the parameter should also be given, while a {@code REF}
   * parameter requires that the fully-qualified type name of the referenced type be given. A JDBC driver that does not need the
   * type code and type name information may ignore it. To be portable, however, applications should always provide these values
   * for user-defined and {@code REF} parameters.
   * <p>
   * Although it is intended for user-defined and {@code REF} parameters, this method may be used to register a parameter of any
   * JDBC type. If the parameter does not have a user-defined or {@code REF} type, the <i>typeName</i> parameter is ignored.
   * <p>
   * <P>
  ...
  /**
   * Registers the OUT parameter named <code>parameterName</code> to the JDBC type {@code sqlType}. All OUT parameters must be
   * registered before a stored procedure is executed.
   * <p>
   * The JDBC type specified by {@code sqlType} for an OUT parameter determines the Java type that must be used in the {@code get}
   * method to read the value of that parameter.
   * <p>
   * If the JDBC type expected to be returned to this output parameter is specific to this particular database, {@code sqlType}
   * should be {@code JDBCType.OTHER} or a {@code SQLType} that is supported by the JDBC driver.. The method {@link #getObject}
   * retrieves the value.
   * <p>
   * The default implementation will throw {@code SQLFeatureNotSupportedException}
   *
  ...
  /**
   * Registers the parameter named <code>parameterName</code> to be of JDBC type {@code sqlType}. All OUT parameters must be
   * registered before a stored procedure is executed.
   * <p>
   * The JDBC type specified by {@code sqlType} for an OUT parameter determines the Java type that must be used in the {@code get}
   * method to read the value of that parameter.
   ...
   * <p>
   * <P>
   * <B>Note:</B> When reading the value of an out parameter, you must use the {@code getXXX} method whose Java type XXX
   * corresponds to the parameter's registered SQL type.
   * <p>
   * The default implementation will throw {@code SQLFeatureNotSupportedException}
   *
